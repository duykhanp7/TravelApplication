  ...
  Widget _buildbody() {
    return AppBackground(
        ...
        children: BlocListener<BlocSignupScreen, BlocSignUpState>(
          listenWhen: (previous, current) => current is BlocSignUpStateValidate,
          listener: (context, state) {
            if (state is BlocSignUpStateValidate) {
          ...
          children: [
            ...
            BlocBuilder<BlocSignupScreen, BlocSignUpState>(
              buildWhen: (previous, current) =>
                  current is BlocSignUpStateValidate,
              builder: (context, state) {
                bool isLoading = state is BlocSignUpStateValidate &&
