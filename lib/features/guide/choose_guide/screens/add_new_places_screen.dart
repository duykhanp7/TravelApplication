...
import 'package:travel_booking_tour/features/guide/choose_guide/blocs/bloc_add_trip_information_event.dart';
    ...
    return Padding(
      ...
      child: BlocBuilder<BlocTripInformationScreen, BlocTripInformationState>(
        buildWhen: (previous, current) =>
            current is BlocTripInformationStateSearchDestinationLoading ||
            current
                is BlocTripInformationStateSearchDestinationLoadingSuccess ||
            current is BlocTripInformationStateSearchDestinationLoadingFail ||
            current is BlocTripInformationStateClose,
        builder: (context, state) {
          if (state is BlocTripInformationStateSearchDestinationLoading) {
            return Container(
              alignment: Alignment.center,
              color: AppColors.white,
