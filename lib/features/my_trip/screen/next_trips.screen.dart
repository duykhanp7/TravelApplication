...
class NextTripsScreen extends StatefulWidget {
  const NextTripsScreen({super.key});

  @override
  State<StatefulWidget> createState() {
    return _NextTripsScreen();
  }
}

class _NextTripsScreen extends State<NextTripsScreen> {
  ...
  void initState() {
    ...
    _blocMyTripScreen
        .add(BlocMyTripEventInitial(tabMyList: TabMyList.nextTrips));
    super.initState();
  }
